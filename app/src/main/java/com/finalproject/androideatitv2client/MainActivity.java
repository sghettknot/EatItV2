...
import com.finalproject.androideatitv2client.Remote.ICloudFunctions;
import com.finalproject.androideatitv2client.Remote.RetrofitCloudClient;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static int APP_REQUEST_CODE = 7174; // any number
    ...
    private void init() {
        ...
        //cloudFunctions = RetrofitCloudClient.getInstance().create(ICloudFunctions.class);     // NO LONGER USED
